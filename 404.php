...
<div class="layout page padding-large-top padding-large-bottom">
	...
	<div class="text-center">
            <h1 class="padding-large-bottom"> 好可惜，您要找的宝贝不在了！</h1>
            <div class="padding">
		...
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=3">
            ...
            <div class="xl6 xs3 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=4">
		...
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=5">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=6">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=7">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=8">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=9">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=10">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=11">
            ...
            <div class="xl6 xs2 padding-bottom">
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=12">
		...
		<a target="_blank" href="<?php bloginfo('url');?>/?cat=13">
