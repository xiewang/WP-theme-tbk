...
<head>
	...
	<link href="<?php bloginfo('template_url'); ?>/ui/version-2017091901.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript"> 
		...
		$(function() {
			...
			var addtohome = addToHomescreen({
			   ...
			   autostart: false,
			   message:{
			   	ios:'为了更方便您的使用，您可以将半刀网收藏到桌面: 点击 %icon 然后点击 <strong>添加到主屏幕</strong>.',
			   	android:'为了更方便您的使用，您可以将半刀网收藏到桌面，您可以点击菜单按钮<small> %icon.</small>，然后<strong>添加到主屏幕</strong>。 <small>部分安卓浏览器没有<strong>添加到主屏幕</strong>功能😭，你也可以点击菜单中的“添加到首页导航”、“添加到书签”等类似功能。</small>'
			   }
			});
			addtohome.show(true);
		});
